...
//"Hola Nick, tu tienes 28 años, 2 meses y 13 días de edad."
...
int main() {
    ...
    string edad= edadEnDiasMesesyAnios(,2,3,"Josue");
    cout<<endl<<edad;
    ...
    cout<<endl<<saludos("Nick");
    cout<<endl<<saludos();
    cout<<endl<<saludos("Ariel");
    cout<<endl<<saludos("Steven", 20);
